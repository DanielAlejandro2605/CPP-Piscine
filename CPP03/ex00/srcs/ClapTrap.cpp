...
/*   Updated: 2023/06/23 21:31:33 by dnieto-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount) {
    if (this->_hit_points == 0 || this->_energy_points == 0)
    {
        std::cout << PURPLE << "Stopping damage! ClapTrap " << this->_name << " has is already died!" RESET << std::endl;
    }
    ...
    else
    {
        ...
        std::cout << YELLOW  << "ClapTrap " << this->_name << " takes damage of " << amount << RESET << std::endl;

...
/*   Updated: 2023/07/04 18:50:23 by dnieto-c         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount) {
    ...
    else
    {
        ...
        std::cout << BGWHITE  << "ClapTrap " << this->_name << " remaining " << this->_hit_points << " hit points." << RESET << std::endl;  
    }
}
...
void	ClapTrap::beRepaired(unsigned int amount) {
    ...
    {
        std::cout << MAGENTA << "ClapTrap " << this->_name << " is died, it can't repared himself." << std::endl;
    }
    else
    {
        this->_hit_points = this->_hit_points + amount;
        ...
        std::cout << GREEN << "ClapTrap " << this->_name << " remaining " << this->_hit_points << " hit points." << RESET << std::endl;   
    }  
}
